...
enum llm_tensor {
    ...
    LLM_TENSOR_ENGRAM_WKV,     // deepseek41
    LLM_TENSOR_ENGRAM_Q,       // deepseek41
    LLM_TENSOR_ENGRAM_K,       // deepseek41
